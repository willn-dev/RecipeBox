...
function addIngredient(){
    ...
    <input name = "ingedient_${count_ingredients}" type="text" required class= "input input-lg input-accent w-full text-lg font-mono">
    <input placeholder="Qty." type="number" name="ingredient_qty_${count_ingredients}" class="input validator input-lg input-accent text-lg font-mono w-1/4"> 
    `;
